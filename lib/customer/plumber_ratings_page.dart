...
class PlumberRatingsPage extends StatefulWidget {
  final int plumberId;
  final String plumberName;

  const PlumberRatingsPage({
    super.key,
  ...
  @override
  State<PlumberRatingsPage> createState() => _PlumberRatingsPageState();
}

class _PlumberRatingsPageState extends State<PlumberRatingsPage> {
  bool _loading = true;
  ...
  Future<void> _fetchRatings() async {
    ...
    final url = Uri.parse(
      'https://aquafixsansimon.com/api/plumber_ratings.php?plumber_id=${widget.plumberId}',
    );
