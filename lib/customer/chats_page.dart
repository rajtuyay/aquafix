...
class _ChatsPageState extends State<ChatsPage> with RouteAware {
  ...
  Future<void> _fetchChats() async {
    ...
    final url = Uri.parse(
      'https://aquafixsansimon.com/api/customer_chats.php?customer_id=$customerId',
    );
          ...
          _chats =
              _chats.map((chat) {
                ...
                if (chatData is Map && chatData['messages'] != null) {
                  ...
                  final hasCustomer = msgList.any(
                    (m) => m['customer_id']?.toString() == _customerId,
                  );
                  if (hasCustomer && msgList.isNotEmpty) {
                    msgList.sort((a, b) {
                      final aid =
  ...
  Future<void> _markLastMessageAsRead(Map<String, dynamic> chat) async {
    final chatId = chat['chat_id'].toString();
    final plumberId = chat['plumber_id'].toString();
    final customerId = _customerId;
    // Only mark as read if last message is from plumber and is unread
                        ...
                        _loading
                            ...
                            : ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                // Use is_unread from backend or Firebase
                                final isUnread =
                                    chat['is_unread'] == '0' ||
                                    chat['is_unread'] == 0;
                                final isOpposite = senderType == 'plumber';
                                ...
                                if ((lastMessage.isEmpty ||
                                  ...
                                  if (isCustomer) {
                                    ...
                                    subtitle =
                                        "${chat['plumber_name']} sent a photo.";
                                    if (isVideo)
                                      subtitle =
                                          "${chat['plumber_name']} sent a video.";
                                  }
                                ...
                                return ListTile(
                                      ...
                                      chat['profile_image'] != null &&
                                          ...
                                          ? CircleAvatar(
                                            ...
                                            backgroundImage: NetworkImage(
                                              'https://aquafixsansimon.com/uploads/profiles/plumbers/${chat['profile_image']}',
                                            ),
                                            radius: 22.sp,
                                          )
                                          : CircleAvatar(
                                  ...
                                  onTap: () async {
                                    ...
                                    final customerId = prefs.getString(
                                      'customer_id',
                                    );
